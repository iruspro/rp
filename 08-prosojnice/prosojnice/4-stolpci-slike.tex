...
\begin{frame}{Konstrukcija pravokotnice na premico $p$ skozi točko $T$}	
	...
	\begin{columns}
		...
		\begin{tikzpicture}
			...
			\draw[gray, thin] (D) arc[start angle=300, end angle=420, radius=2] node[left] {\scriptsize \(m\)};

			% Naloga 3.4.3.: Definirajte točko T'' in narišite lok n z oznako.
			\pause
			\coordinate (E) at ({-\tDx}, {\tDy});
			\draw[gray, thin] (E) arc[start angle=240, end angle=120, radius=2] node[right] {\scriptsize \(n\)};
